...
### Tag: package-2015-04-only and go

These settings apply only when `--tag=package-2015-04-only --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

``` yaml $(tag) == 'package-2015-04-only' && $(go)
output-folder: $(go-sdk-folder)/services/$(namespace)/mgmt/2015-04/$(namespace)
```
