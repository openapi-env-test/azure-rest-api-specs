...
#### Tag: package-pure-2020-02-preview and go

These settings apply only when `--tag=package-pure-2020-02-preview --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

``` yaml $(tag) == 'package-pure-2020-02-preview' && $(go)
output-folder: $(go-sdk-folder)/services/preview/$(namespace)/mgmt/2020-02-preview/$(namespace)
```
