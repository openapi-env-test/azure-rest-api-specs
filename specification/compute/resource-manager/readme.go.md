...
### Tag: package-2020-09-30-only and go

These settings apply only when `--tag=package-2020-09-30-only --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

```yaml $(tag)=='package-2020-09-30-only' && $(go)
namespace: compute
output-folder: $(go-sdk-folder)/services/preview/$(namespace)/mgmt/2020-09-30-preview/$(namespace)
```
